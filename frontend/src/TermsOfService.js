...
function TermsOfService() {
  return (
    <>
      ...
      <h2>Services</h2>
      <p>Our app provides AI chat-based scheduler services, including reading your Google Calendar schedule and creating events. All data is exchanged through Google Calendar using OAuth authentication, with explicit permission from the user. The services are provided on an 'as is' basis without warranties of any kind, either expressed or implied.</p>
      ...
      <p>Our app uses Google API services. All usage of the Google services is per <a href="https://developers.google.com/terms/api-services-user-data-policy">Google's API Services User Data Policy</a>.</p>
      ...
      <p>This Terms of Service is effective as of November 1, 2023.</p>
    </>
  );
}
